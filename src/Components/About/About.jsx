...
import CV from "../../assets/Kashan-CV.pdf";
      ...
      <div className="about_container container grid">
        ...
        <div className="about__data">
          ...
          Full Stack Developer , with 2 Years Of Experience Learning
            From Youtube , I can create web pages with UI / UX  FronEnd & BackEnd user interface,
            may clients are happy with projects carried out.
          </p>
